...
├── tiers/
│   ├── 01-beginner.md              📘 Phase 1: Fundamentals
│   ├── 02-intermediate.md          📗 Phase 2: Scalable systems
│   ├── 03-advanced.md              📕 Phase 3: Distributed systems
│   └── 04-expert.md                📙 Phase 4: Real-world architectures
├── 5-minute-reads/                 ⚡ Quick-hit primers (5 min each)
│   ├── README.md                   (Index of all 5-min reads)
│   └── 20 focused topic files
├── deep-dives/
│   └── tradeoffs.md                🔬 HLD/LLD trade-offs long-form
└── _archive/                       (not built into the SPA — kept for reference)
    ├── github-repos.md
...
|---|---|---|---|
| **1** | 📘 [Beginner](./tiers/01-beginner.md) | 3-4 months | Networking, OS basics, scalability fundamentals, single-server → multi-server thinking, basic DB/cache/load-balancer |
| **2** | 📗 [Intermediate](./tiers/02-intermediate.md) | 4-6 months | Microservices, sharding, caching strategies, message queues, real interview problems (Twitter, WhatsApp, Uber) |
| **3** | 📕 [Advanced](./tiers/03-advanced.md) | 6-12 months | CAP/PACELC, Raft/Paxos, distributed transactions, LSM-trees, CRDTs, event sourcing, papers |
| **4** | 📙 [Expert](./tiers/04-expert.md) | Ongoing | Netflix/Uber/Discord case studies, design docs, mentorship, org-level architecture |
...
2. 📘 Open [01-beginner.md](./tiers/01-beginner.md) for the structured deep-dive plan
...
- See: [01-beginner.md](./tiers/01-beginner.md)
...
- See: [02-intermediate.md](./tiers/02-intermediate.md)
...
- See: [03-advanced.md](./tiers/03-advanced.md)
...
- See: [04-expert.md](./tiers/04-expert.md)
